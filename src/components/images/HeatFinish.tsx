        ...
        var box = <g key="layer1">
            {
                this.props.lanes.map((lane, index) => {
                    ...
                    if (lane.finishtime !== 'undefined' && lane.place !== 'undefined') {
                        ...
                        var text 
                        if (this.props.orientation === laneOrientation.right) {
                            text = this.getNameTextRight(lane.lane, "text" + index, firstname + " " + lastname, this.getStartPoint(lane.lane))
                        } else {
                            text = this.getNameTextLeft(lane.lane, "text" + index, firstname + " " + lastname, this.getStartPoint(lane.lane))
                        }
