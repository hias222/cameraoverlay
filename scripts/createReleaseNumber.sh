...
# zip name
release_file_name=cameraoverlay_react
...
zip -j /tmp/${release_file_name}.zip build/*
gh release upload $versionLabel /tmp/${release_file_name}.zip#${release_file_name}_$versionLabel.zip
rm /tmp/${release_file_name}.zip
